...
bool vmm_map_page(PageDirectory* pageDirectory, uint32_t virtualAddress, size_t size, uint32_t physicalAddress, uint32_t flags);
bool vmm_unmap_page(PageDirectory* pageDirectory, uint32_t virtualAddress);

void vmm_init_pd(PageDirectory* pageDirectory);